...
<details class="advanced-runtime" open><summary>Runtime inspector (read only)</summary><p data-advanced="runtime-state"></p><button type="button" data-advanced="runtime-refresh">Refresh runtime</button><div data-advanced="runtime"></div></details>`;
  ...
  private click(event: Event): void {
    ...
    switch (target.dataset.advanced) {
      ...
      case 'runtime-refresh': if (this.view.binding) this.send({ type: 'runtime.inspect', binding: this.view.binding }); break;
