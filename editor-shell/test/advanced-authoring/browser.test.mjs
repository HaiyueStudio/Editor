...
test('real Electron advanced authoring panel and native Gizmo lifecycle', {timeout:90000}, async()=>{
  const output = new URL('./test-output/',import.meta.url); await mkdir(output,{recursive:true});
